...
const initialEmployees = [
  { 
    ...
    details: {
      metrics: { hardSkills: 95, softSkills: 98, delivery: 100, leadership: 99 },
  ...
  { 
    ...
    details: {
      metrics: { hardSkills: 99, softSkills: 85, delivery: 95, leadership: 90 },
  ...
  { 
    ...
    details: {
      metrics: { hardSkills: 92, softSkills: 90, delivery: 98, leadership: 85 },
  ...
  { 
    ...
    details: {
      metrics: { hardSkills: 88, softSkills: 95, delivery: 90, leadership: 92 },
      sources: ['Salesforce', 'Client NPS', 'Revenue Reports'],
      summary: 'Strong client relationships and revenue growth. Needs to align closer with product roadmap timelines.',
      recommendations: [
        'Align sales commitments with engineering capacity',
        'Lead the quarterly business review workshop'
      ]
    }
  },
  { 
    ...
    details: {
      metrics: { hardSkills: 80, softSkills: 85, delivery: 82, leadership: 75 },
...
const EmployeeView: React.FC = () => {
  ...
  const handleAddEmployee = (e: React.FormEvent) => {
    ...
    const newEmp = {
      ...
      details: {
        metrics: { hardSkills: 50, softSkills: 50, delivery: 50, leadership: 50 },
        sources: ['Onboarding'],
        summary: 'New hire, assessment pending.',
        recommendations: ['Complete Onboarding Bootcamp']
      }
    };
                    ...
                    <tr className="bg-gray-50/50 dark:bg-slate-800/50 animate-in fade-in slide-in-from-top-2 duration-200">
                      <td colSpan={6} className="p-0">
                        <div className="p-6 border-b border-gray-100 dark:border-slate-700 grid grid-cols-1 lg:grid-cols-3 gap-8">
                          ...
                          {/* COL 1: Metrics & Sources */}
                          <div className="space-y-6">
                             <div>
                               <h4 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-4 flex items-center gap-2">
                                 <Target size={14} /> Performance Metrics
                               </h4>
                               <div className="space-y-3">
                                 {[
                                   { label: 'Hard Skills', val: emp.details.metrics.hardSkills, color: 'bg-blue-500' },
                                   { label: 'Soft Skills', val: emp.details.metrics.softSkills, color: 'bg-green-500' },
                                   { label: 'Delivery', val: emp.details.metrics.delivery, color: 'bg-[#E30611]' },
                                   { label: 'Leadership', val: emp.details.metrics.leadership, color: 'bg-purple-500' }
                                 ].map((m, i) => (
                                   <div key={i}>
                                     <div className="flex justify-between text-xs mb-1">
                                       <span className="font-medium text-slate-600 dark:text-gray-300">{m.label}</span>
                                       <span className="font-bold text-slate-800 dark:text-white">{m.val}%</span>
                                     </div>
